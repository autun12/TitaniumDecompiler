...
class DomHelperTest : public ::testing::Test {
    protected:
        ...
        void SetUp() override {
            b0 = std::make_shared<BasicBlock>(); b0->m_ID = 0;
            b1 = std::make_shared<BasicBlock>(); b1->m_ID = 1;
            b2 = std::make_shared<BasicBlock>(); b2->m_ID = 2;
            b3 = std::make_shared<BasicBlock>(); b3->m_ID = 3;
            ...
            Insn i1; i1.opcodeName = "iadd";      i1.group = GROUP_GENERAL;
            Insn i2; i2.opcodeName = "istore_1";  i2.group = GROUP_GENERAL;
            Insn i3; i3.opcodeName = "if_icmpge"; i3.group = GROUP_JUMP;
            Insn i4; i4.opcodeName = "return";    i4.group = GROUP_RETURN;
