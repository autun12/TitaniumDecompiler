...
public:
    ...
    bool IsStreamGood() const override { return m_Pos < m_Data.size(); }
...
protected:
    std::unique_ptr<MockStreamReader> MakeReaderFromVector(
...
TEST_F(AttributesTest, DeserializeMultipleAttributes) {
    std::vector<uint8_t> data = {
        0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,  // attr 1
