...
//
//     std::map<std::shared_ptr<TitaniumDecompiler::BasicBlock>, int>
//     nodeDepths; std::map<std::shared_ptr<TitaniumDecompiler::BasicBlock>,
//     float>
//         nodeXPositions;
//     std::map<int,
//     std::vector<std::shared_ptr<TitaniumDecompiler::BasicBlock>>>
//         blocksByDepth;
//
...
//                     y_offset +
//                         depth * depth_spacing);  // Adjust multipliers as
//                         needed
//             }
//         }
