...
struct IntegerInfo : public ConstPool {
    ...
    static void Deserialize(BigEndianStreamReader* deserializer,
                            IntegerInfo& instance) {
        deserializer->ReadRawBigEndian<uint32_t>(instance.bytes);
    }
...
struct LongInfo : public ConstPool {
    ...
    static void Deserialize(BigEndianStreamReader* deserializer,
                            LongInfo& instance) {
        deserializer->ReadRawBigEndian<uint64_t>(instance.bytes);
    }
...
struct StringInfo : public ConstPool {
    ...
    static void Deserialize(BigEndianStreamReader* deserializer,
                            StringInfo& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(instance.stringIndex);
    }
...
struct MethodRefInfo : public ConstPool {
    ...
    void Deserialize(BigEndianStreamReader* deserializer,
                     ConstPool& instance) override {
        MethodRefInfo& methodInfoInstance =
            static_cast<MethodRefInfo&>(instance);
        Deserialize(deserializer, methodInfoInstance);
    }

    static void Deserialize(BigEndianStreamReader* deserializer,
                            MethodRefInfo& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(instance.classIndex);
        deserializer->ReadRawBigEndian<uint16_t>(instance.nameAndTypeIndex);
    }
...
struct InterfaceMethodRef : public ConstPool {
    ...
    void Deserialize(BigEndianStreamReader* deserializer,
                     ConstPool& instance) override {
        InterfaceMethodRef& interfaceMethodInfoInstance =
            static_cast<InterfaceMethodRef&>(instance);
        Deserialize(deserializer, interfaceMethodInfoInstance);
    }

    static void Deserialize(BigEndianStreamReader* deserializer,
                            InterfaceMethodRef& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(instance.classIndex);
        deserializer->ReadRawBigEndian<uint16_t>(instance.nameAndTypeIndex);
    }
...
struct NameAndTypeInfo : public ConstPool {
    ...
    void Deserialize(BigEndianStreamReader* deserializer,
                     ConstPool& instance) override {
        NameAndTypeInfo& nameAndTypeInfoInstance =
            static_cast<NameAndTypeInfo&>(instance);
        Deserialize(deserializer, nameAndTypeInfoInstance);
    }

    static void Deserialize(BigEndianStreamReader* deserializer,
                            NameAndTypeInfo& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(instance.nameIndex);
...
struct MethodHandleInfo : public ConstPool {
    ...
    void Deserialize(BigEndianStreamReader* deserializer,
        ...
        MethodHandleInfo& methodHandleInfoInstance =
            static_cast<MethodHandleInfo&>(instance);
        Deserialize(deserializer, methodHandleInfoInstance);
    }

    static void Deserialize(BigEndianStreamReader* deserializer,
                            MethodHandleInfo& instance) {
...
struct MethodTypeInfo : public ConstPool {
    ...
    void Deserialize(BigEndianStreamReader* deserializer,
                     ConstPool& instance) override {
        MethodTypeInfo& methodTypeInfoInstance =
            static_cast<MethodTypeInfo&>(instance);
        Deserialize(deserializer, methodTypeInfoInstance);
    }

    static void Deserialize(BigEndianStreamReader* deserializer,
                            MethodTypeInfo& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(instance.descriptorIndex);
    }
...
struct DynamicInfo : public ConstPool {
    ...
    static void Deserialize(BigEndianStreamReader* deserializer,
                            DynamicInfo& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(
            instance.bootstrapMethodAttrIndex);
        deserializer->ReadRawBigEndian<uint16_t>(instance.nameAndTypeIndex);
    }
...
struct InvokeDynamicInfo : public ConstPool {
    ...
    void Deserialize(BigEndianStreamReader* deserializer,
                     ConstPool& instance) override {
        InvokeDynamicInfo& invokeDynamicInfoInstance =
            static_cast<InvokeDynamicInfo&>(instance);
        Deserialize(deserializer, invokeDynamicInfoInstance);
    }

    static void Deserialize(BigEndianStreamReader* deserializer,
                            InvokeDynamicInfo& instance) {
        deserializer->ReadRawBigEndian<uint16_t>(
            instance.bootstrapMethodAttrIndex);
        deserializer->ReadRawBigEndian<uint16_t>(instance.nameAndTypeIndex);
    }
...
using ConstPoolVariant =
    std::variant<std::monostate, UTF8Info, IntegerInfo, FloatInfo, LongInfo,
                 DoubleInfo, ClassInfo, StringInfo, FieldRefInfo, MethodRefInfo,
                 InterfaceMethodRef, NameAndTypeInfo, MethodHandleInfo,
                 MethodTypeInfo, DynamicInfo, InvokeDynamicInfo, ModuleInfo,
                 PackageInfo>;

struct ConstPoolInfo {
public:
    Tags Tag = Tags::Utf8;
    ConstPoolVariant Info;
    ...
    // ConstPoolInfo(Tags tag, ConstPool* info)
    //     : Tag(tag), Info(std::move(info)) {}
    //
    // UTF8Info* asUTF8Info() {
    //     return Tag == Tags::Utf8 ? dynamic_cast<UTF8Info*>(Info.get())
    //                              : nullptr;
    // }
    // ClassInfo* asClassInfo() {
    //     return Tag == Tags::Class ? dynamic_cast<ClassInfo*>(Info.get())
    //                               : nullptr;
    // }
    // NameAndTypeInfo* asNameAndType() {
    //     return Tag == Tags::NameAndType
    //                ? dynamic_cast<NameAndTypeInfo*>(Info.get())
    //                : nullptr;
    // }
    // StringInfo* asStringInfo() {
    //     return Tag == Tags::String ? dynamic_cast<StringInfo*>(Info.get())
    //                                : nullptr;
    // }
    // IntegerInfo* asIntInfo() {
    //     return Tag == Tags::Int ? dynamic_cast<IntegerInfo*>(Info.get())
    //                             : nullptr;
    // }
    // FloatInfo* asFloatInfo() {
    //     return Tag == Tags::Float ? dynamic_cast<FloatInfo*>(Info.get())
    //                               : nullptr;
    // }
    // MethodRefInfo* asMethodRefInfo() {
    //     return Tag == Tags::Method ? dynamic_cast<MethodRefInfo*>(Info.get())
    //                                : nullptr;
    // }
    // // ClassInfo* asClassInfo() { return Tag == Tags::Class ?
    // // dynamic_cast<ClassInfo*>(Info.get()) : nullptr; } ClassInfo*
    // // asClassInfo() { return Tag == Tags::Class ?
    // // dynamic_cast<ClassInfo*>(Info.get()) : nullptr; } ClassInfo*
    // // asClassInfo() { return Tag == Tags::Class ?
    // // dynamic_cast<ClassInfo*>(Info.get()) : nullptr; }
    // InvokeDynamicInfo* asInvokeDynamicInfo() {
    //     return Tag == Tags::InvokeDynamic
    //                ? dynamic_cast<InvokeDynamicInfo*>(Info.get())
    //                : nullptr;
    // }
    ...
    // public:
    //     Tags Tag;
    //     std::unique_ptr<ConstPool> Info;

    // private:
    //     std::unique_ptr<ConstPool> CreateConstPoolItemFromTag(
    //         ConstPoolInfo& instance);
};
