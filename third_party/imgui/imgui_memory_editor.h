...
struct MemoryEditor {
    ...
    bool (*HighlightFn)(
        const ImU8* data,
        size_t off);  //= 0      // optional handler to return Highlight
    ...
    void DrawContents(void* mem_data_void, size_t mem_size,
        ...
        // rely on visible_start_addr/visible_end_addr for our scrolling
        // function.
             ...
             line_i++)  // display only visible lines
        {
            ...
            if (OptShowAscii) {
                ...
                for (int n = 0; n < Cols && addr < mem_size; n++, addr++) {
                    ...
                    draw_list->AddText(
                        pos, (display_c == c) ? color_text : color_disabled,
    ...
    void DrawPreviewLine(const Sizes& s, void* mem_data_void, size_t mem_size,
        ...
        if (has_value)
            DrawPreviewData(DataPreviewAddr, mem_data, mem_size,
