...
#define IM_VEC4_CLASS_EXTRA \
        IM_NODEBUGSTEP constexpr inline ImVec4(const MyVec4& f) : x(f.x),
y(f.y), z(f.z), w(f.w) {}    \ IM_NODEBUGSTEP inline operator MyVec4() const {
return MyVec4(x,y,z,w); }
*/
//---- ...Or use Dear ImGui's own basic math operators in every file including
//imgui.h: #ifndef IMGUI_DEFINE_MATH_OPERATORS #define
// IMGUI_DEFINE_MATH_OPERATORS #endif
//---- ...Or manually '#define IMGUI_DEFINE_MATH_OPERATORS' before '#include
//"imgui.h"' to use from one file.
